...
export default class Results extends React.Component {
  ...
  render() {
    ...
    Session.set("currQueryId", query._id);
    return (
      <div> <div id="resDone">
        <BootstrapTable data={ query.resultsArr } deleteRow={ true } options={ this.options } selectRow={ selectRowProp } responsive striped hover id="searchDone">
          <TableHeaderColumn dataField='shortid' columnClassName={ columnClassNameFormat } isKey dataSort dataFormat={ shortidFormatter } width='4%'>Query</TableHeaderColumn>
          <TableHeaderColumn dataField='text' columnClassName={ columnClassNameFormat } dataSort>Text</TableHeaderColumn>
          <TableHeaderColumn dataField='emotion' columnClassName={ columnClassNameFormat } dataSort width='10%'>Emotion</TableHeaderColumn>
          ...
          <TableHeaderColumn dataField='shortid' columnClassName={ columnClassNameFormat } dataSort dataFormat={ delFormatter } width='4%'>Delete</TableHeaderColumn>
